define(function(require, exports, module) {
    require('jquery-plugin/jquery.blockUI');
    require('jquery-plugin/poshytip-1.1/jquery.poshytip.min.js');
    var jQuery =require('jquery-plugin/jquery-validation-1.8.1/jquery.validate.min.js');
var jqueryUtil={};
/**
...
jQuery(function(){
	...
	if(!ajaxBusy || ajaxBusy.attr('id')!='ajaxBusy'){
		jQuery("body").append('<div id="ajaxBusy" align="center">正在执行请求...</div>');
	}
	jQuery('#ajaxBusy').css( {
		display : "none",
		margin : "0px",
