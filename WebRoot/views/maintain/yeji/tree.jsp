...
<head>
    ...
    <script>
        ...
        var setting = {
            async: {
                enable: true,
                url: '${path}/maintain/yejiclassify/tree',
                autoParam: ['id']
            },
            data: {
                simpleData: {
            ...
            callback: {
                onClick: function (event, treeId, treeNode) {
                    window.frames['moduleFrame'].location.href = '${path}/maintain/yejiclassify/getTreeSelected/' + treeNode.id;
                },
...
<div id="layout1" style="width:99.2%;height:99.2%; margin:0 auto; margin-top:4px; ">
    <div position="left" id="accordion1" title="业绩分类树">
        <div id="treeC" class="ztree"></div>
    </div>
    <div position="center" id="framecenter" title="业绩管理">
