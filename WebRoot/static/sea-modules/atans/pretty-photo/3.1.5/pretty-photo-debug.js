/* ------------------------------------------------------------------------
	...
	Version: 3.1.5
------------------------------------------------------------------------- */
define("atans/pretty-photo/3.1.5/pretty-photo-debug", [ "$-debug" ], function(require, exports, module) {
    ...
    (function($) {
        ...
        $.fn.prettyPhoto = function(pp_settings) {
            ...
            var matchedObjects = this, percentBased = false, pp_dimensions, pp_open, // prettyPhoto container specific
            pp_contentHeight, pp_contentWidth, pp_containerHeight, pp_containerWidth, // Window size
            windowHeight = $(window).height(), windowWidth = $(window).width(), // Global elements
            pp_slideshow;
